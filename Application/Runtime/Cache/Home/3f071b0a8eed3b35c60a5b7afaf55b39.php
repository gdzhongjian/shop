            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo U('category/secondlist');?>">查看商品二级分类</a>
                        </li>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12">
                                 <div class="panel-heading">
                                        ...
                                        <span class="badge badge-danager animated bounceIn">已有<?php echo ($count); ?>个二级分类</span>    
    ...
    <script>
        $(document).ready(function(){
            $(".demo4").click(function(){
                swal({title:"您确定要删除这个分类吗",text:"同时删除该分类下面的三级分类，请谨慎操作！",type:"warning",showCancelButton:true,confirmButtonColor:"#DD6B55",confirmButtonText:"是的，我要删除！",cancelButtonText:"让我再考虑一下…",closeOnConfirm:false,closeOnCancel:false},
                    function(isConfirm){
                        if(isConfirm){
