...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="<?php echo U('goods/appointgoods');?>">查看指定商品</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div id="tab-3" class="tab-pane active">
                            <div class="panel-body">
                             ...
                             <div class="col-sm-12">
                                <form action="<?php echo U('appointgoodsselect');?>" method="post" id="form" class="form-horizontal m-t">
    ...
    <script src="/shop/Public/admin/js/goods/list2.js"></script>
    <script>
