            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li><a  href="<?php echo U('category/index');?>">查看商品一级分类</a>
                        </li>
                        <li><a href="<?php echo U('category/secondlist');?>">查看商品二级分类</a>
                        </li>
                        <li class="active"><a  href="<?php echo U('category/thirdlist');?>">查看商品三级分类</a>
                        </li>
                            ...
                            <div class="panel-body">
                                <div class="col-sm-12">
                                 <div class="panel-heading">
                                        ...
                                        <span class="badge badge-danager animated bounceIn">已有<?php echo ($count); ?>个三级分类</span>    
                        ...
                        <div class="example">
                            <table class="table table-bordered">
                                ...
                                <?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td style="text-align: center;"><?php echo ($parentname[$i]); ?></td>
     ...
     <script>
        $(document).ready(function(){
            $(".demo4").click(function(){
                swal({title:"您确定要删除这条分类吗",text:"删除后将无法恢复，请谨慎操作！",type:"warning",showCancelButton:true,confirmButtonColor:"#DD6B55",confirmButtonText:"是的，我要删除！",cancelButtonText:"让我再考虑一下…",closeOnConfirm:false,closeOnCancel:false},
                    function(isConfirm){
                        if(isConfirm){
