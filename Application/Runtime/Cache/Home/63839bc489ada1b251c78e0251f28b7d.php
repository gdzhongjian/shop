            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="<?php echo U('goods/index');?>">全部商品</a>
                        </li>
                        <li class=""><a href="<?php echo U('goods/list1');?>">分类商品</a>
                        </li>
                        ...
                        <div class="example">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php if(is_array($goods)): $num = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($num % 2 );++$num;?><tr>
                                        ...
                                        <td style="text-align: center;">
                                            <?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i; if($vo['shop_goods_category_id'] == $category['id']): echo ($category["name"]); endif; endforeach; endif; else: echo "" ;endif; ?>
                                        </td>
                                        <td style="text-align: center;">
